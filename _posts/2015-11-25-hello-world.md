...
Build the entire site in Spanish, my mother tongue, would of course be easier; but we live as Web Developers on the Internet, where people use to write in English, where Web Documentation use to be in English to and where articles, tutorials, videos, newsletters and much more is also in English so the way to communicate with many others is to write better. (If someone wants to know anything about I've written and don't understand something <a class="link link--special" href="/about/#contact">contact me</a>.

  <blockquote class="">
    <span>Not being a native English speaker, I apologize in advance for any spelling or grammatical errors, so; if you find one and want to let me know, <a class="link link--special" href="/about/#contact">contact me</a>.
    </span>
  </blockquote>

Knowing this, I really appreciate that if someone ever read this gives me feedback <a class="link link--special" href="/about/#contact">contacting me</a>, <a class="link link--special" href="{{ site.twitter }}">Twitter</a> or in the comments below.
