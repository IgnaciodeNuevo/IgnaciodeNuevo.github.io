...
Espero no ofender a nadie. Si se diese el caso ruego me escribáis a <a class="link" href="mailto:{{ site.email }}" target="_blank" rel="noopener noreferrer">{{ site.email }}</a>.
</blockquote>
...
<div class="related">
    ...
    <ul class="related__list">
        ...
        <li><a class="link link--special" href="https://www.youtube.com/channel/UC_rIWyZeGjIXSsW6VDDmfwQ" target="_blank" rel="noopener noreferrer">Devermut</a></li>
    </ul>
</div>
