...
Espero no ofender a nadie. Si se diese el caso ruego me escribáis a <a class="link link--special" href="mailto:{{ site.email }}" target="_blank" rel="noopener">{{ site.email }}</a>.
</blockquote>
